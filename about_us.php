 ...
 <br>
   <h1 style="color:#C52128; font-size:22px;"><b>Our Pride</b></h1></br><hr>
        <article>
            ...
            <div class="m_img"><img src="img/pr.jpg" width="120" style="border-radius:60px"></div>
        </article>
    <br>
        <article>
           <div class="m_desp">
            ...
            <p>Nivi, with over 10years of problem solving experience, plays a key role to the company for both internal & external communication. Extremely detailed and ability to bridge gap between engineering & management puts her in such a key role for us.</p>
              ...
              <div class="m_img"><img src="img/nr.jpg" width="120" style="border-radius:60px"></div>
        </article>
    <br>
        <article>
            <div class="m_desp">
...
<div class="wrap">
    <h1 style="color:#C52128; font-size:22px;"><b>Contact Us</b></h1><br>
    <div class="contact1">
        <ul class="text-block">
            <li><h1><strong>Development Center</strong></h1></li>
    ...
    <div class="contact3">
        <ul class="email_cont">
            <li><img src="img/emailus.png" width="40"><p><a href="mailto:contact@maisasolutions.com">contact@maisasolutions.com</a></p></li>
