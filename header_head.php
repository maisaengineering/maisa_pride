...
<html lang="en">
			...
			<meta name="description" content="We offer various IT Offshore Services and Solutions Ruby on Rails india at Low Cost and High Standards. Our Offshore Services include Hire-A-Developer on Ruby on Rails india, PHP|HTML5|CSS3|Java Script|AJAX|Ruby on Rails|Mobile|Tablet|Web|eCommerce|RIA Applications Development,SEO|RDBMS|NoSQL Design,Facebook|Twitter|3rd Party integrations…much more" />
			<meta name="keywords" content="Ruby on Rails Developers,Ruby on Rails india, Rails in india, Ruby in india,Ruby on rails in hyderabad, Ruby on rails companies in india, Rails companies, Ruby companies, Ruby on Rails in hyderabad, Ruby on Rails development india,Rails development, Ruby development, Ruby on Rails web development, Rails web services, Ruby on Rails Web Application,Ruby on Rails Web Development, Rails Developers, Ruby on Rails Development team, Hire offshore Developer, Offshore Mobile Development, Offshore Software Services, Offshore Web Development, Facebook Apps development, AJAX, JavaScript, HTML5, CSS3, Ruby on Rails, Java, .NET, Content Management Systems, Flash, NoSQL Databases, Toolbar Development, Most trusted result oriented offshore services, Games development, IPhone/IPAD Applications Development, ANDRIOD Development, Windows Development, Symbian Development, Hire Offshore Dvelopers, Hire Mobile Developers, Hire Developers, Hire a Developer, Our Core Values" />
